...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof com.simplemobiletools.gallery.svg.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new com.simplemobiletools.gallery.svg.GlideOptions().apply(toSet));
    }
  }
}
